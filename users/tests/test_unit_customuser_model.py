...
class TestCustomUserModel(TestCase):
    def test_that_create_user_method_should_raise_custom_validation_error_when_email_is_none(self):
        ...
        self.assertEqual(CustomValidationErrorText.VALIDATION_ERROR_EMAIL_MESSAGE, custom_exception.exception.message)
    ...
    def test_that_create_user_method_should_raise_custom_validation_error_when_password_is_none(self):
        ...
        self.assertEqual(
            CustomValidationErrorText.VALIDATION_ERROR_PASSWORD_MESSAGE, custom_exception.exception.message
        )
    ...
    def test_user_with_email_without_at_least_one_at_sign_full_clean_should_raise_validation_error(self):
        ...
        self.assertTrue(
            CustomValidationErrorText.VALIDATION_ERROR_EMAIL_AT_SIGN_MESSAGE in exception.exception.messages
        )
